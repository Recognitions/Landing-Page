<section class="home">
    <div class="inner-home">
        <div class="inner-home-div">
            <img width="600" src="images/text.png"/>
            <label><h3>Assista à parte 2 agora</h3></label>
            <label>
            Reptilianos? Verdade. Pouso na lua? Mentira. Manter as <br>
            conspirações do mundo em segredo é um trabalho e tanto para <br>
            essa cientista antissocial e seus peculiares colegas.
            </label>
            <div class="inner-home-buttons">
                <button>
        ...
        <div class="inner-home-div-2">
            <h3>Recomendações</h3>
            <div>
                <img width="250" src="images/img1.jpg"/>
                <img width="250" src="images/img2.jpg"/>
                <img width="250" src="images/img3.jpg"/>
                <img width="250" src="images/img4.jpg"/>
                <img width="250" src="images/img5.jpg"/>
                <img width="250" src="images/img6.jpg"/>
            </div>
        </div>
    </div>
</section>